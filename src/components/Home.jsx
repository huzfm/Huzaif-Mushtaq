      ...
      return (
            <>
                  ...
                  <a href="mailto:huzaaifmushtaq@gmail.com">
                        <button className="absolute top-5 right-4 bg-neutral-800 text-white p-3 rounded-full shadow-lg hover: focus:outline-none flex items-center justify-center">
                  ...
                  <div className="w-full h-screen flex flex-col items-center justify-center relative p-4">
                        ...
                        <div
                              className="absolute w-80 h-80 rounded-full bg-cover bg-center bg-opacity-30 z-0 top-[-1%]"
                              style={{
