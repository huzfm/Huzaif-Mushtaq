      ...
      return (
            <>
                  ...
                  <a href="mailto:huzaaifmushtaq@gmail.com">
                        <button className="absolute top-5 right-4 bg-slate-100  p-3 rounded-full shadow-lg hover: focus:outline-none flex items-center justify-center hover:bg-slate-300">
                  ...
                  <div className="w-full h-screen flex flex-col items-center justify-center relative p-4">
                        ...
                        <div className="relative z-10 ">
                              <h1 className="text-transparent bg-clip-text bg-gradient-to-b from-white via-slate-300 to-stone -900 text-5xl sm:text-5xl md:text-6xl lg:text-8xl  font-thin">
                                    Huzaif Mushtaq
                              </h1>
                        </div>
                        <Scroll />
